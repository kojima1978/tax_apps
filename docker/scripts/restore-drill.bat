@echo off
:: ============================================
:: Tax Apps - Restore Drill (Windows helper)
:: ============================================
:: Delegates to backup.sh drill via Git Bash.
:: The main drill logic lives in backup.sh.
...
"%GIT_BASH%" --login "%~dp0backup.sh" drill %*
exit /b %ERRORLEVEL%
