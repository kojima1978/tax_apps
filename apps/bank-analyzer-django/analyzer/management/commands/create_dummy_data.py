...
RECURRING_TRANSACTIONS = [
    ...
    # 銀行関連
    ('利息', None, (1, 500), '銀行・利息・手数料', 4),
    ('振込手数料', (220, 880), None, '銀行・利息・手数料', 6),

    # 証券・株式
    ('野村證券', (100000, 500000), None, '証券・株式・配当', 3),
    ('野村證券 配当金', None, (10000, 100000), '証券・株式・配当', 4),
    ('SBI証券', (50000, 300000), None, '証券・株式・配当', 2),
    ('SBI証券 売却代金', None, (100000, 500000), '証券・株式・配当', 2),
    ...
    # 贈与
    ('フリコミ ヤマダタロウ', None, (1000000, 3000000), '贈与・教育費', 1),
    ('フリコミ ヤマダハナコ', (500000, 1100000), None, '贈与・教育費', 2),
