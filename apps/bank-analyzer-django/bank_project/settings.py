...
# STATIC_URL はプレフィックスなし。テンプレートURL生成は ScriptNameStaticFilesStorage が
# FORCE_SCRIPT_NAME を自動付与するため、Nginx プレフィックス除去後のパスと一致する。
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "bank_project.storage.ScriptNameStaticFilesStorage",
    },
}
