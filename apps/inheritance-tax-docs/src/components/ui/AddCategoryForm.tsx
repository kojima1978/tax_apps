  ...
  if (!isAdding) {
    return (
      <button
        ...
        className="w-full flex items-center justify-center px-6 py-4 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/50 rounded-xl border-2 border-dashed border-emerald-300 dark:border-emerald-700 transition-all font-medium hover:border-emerald-400 dark:hover:border-emerald-600 hover:shadow-sm"
