...
| 緊急フラグ | 書類に緊急マークを設定（赤バッジ表示、統計バーに緊急件数、Excel出力に【急】プレフィックス） |
