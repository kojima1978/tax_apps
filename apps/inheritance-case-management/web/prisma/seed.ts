  ...
  const cases = await Promise.all([
    prisma.inheritanceCase.create({
      data: {
        ...
        feeCalculationHeirCount: 3,
        referralFeeRate: 10,
        referralFeeAmount: 200000,
        estimateReferralFeeAmount: 250000,
    ...
    prisma.inheritanceCase.create({
      data: {
        ...
        fiscalYear: 2024,
        status: '申告済',
        caseAddedDate: '2024-11-15',
        caseCompletedDate: '2025-01-10',
        taxAmount: 80000000,
        feeAmount: 3500000,
        ...
        feeCalculationHeirCount: 4,
        referralFeeRate: 15,
        referralFeeAmount: 525000,
        estimateReferralFeeAmount: 525000,
        assigneeId: assignees[0].id,
    ...
    prisma.inheritanceCase.create({
      data: {
        ...
        estimateReferralFeeAmount: 100000,
    ...
    prisma.inheritanceCase.create({
      data: {
        ...
        fiscalYear: 2024,
        status: '入金済',
        caseAddedDate: '2024-08-20',
        caseCompletedDate: '2024-10-15',
        billedDate: '2024-10-20',
        paidDate: '2024-11-05',
        taxAmount: 35000000,
        feeAmount: 1500000,
        estimateAmount: 1500000,
