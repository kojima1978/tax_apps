...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const { status, isUndivided, hideClosed, fiscalYear, fiscalYears, search, assigneeId, internalReferrerId, staffId, referrerCompany, unassigned, noReferrer, deadlineSoon, department, caseAddedFrom, caseAddedTo, caseCompletedFrom, caseCompletedTo, billedFrom, billedTo, paidFrom, paidTo } =
