...
export const FILTER_KEYS = ['search', 'status', 'handlingStatus', 'acceptanceStatus', 'fiscalYear', 'department', 'assigneeId', 'internalReferrerId', 'staffId', 'referrerCompany', 'unassigned', 'noReferrer'] as const
