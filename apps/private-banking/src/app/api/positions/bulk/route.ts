...
const bulkEntryCategories = new Set(["DEPOSIT", "SECURITIES", "PRIVATE_SHARES", "HOME_REAL_ESTATE", "REAL_ESTATE", "BUSINESS_REAL_ESTATE", "IDLE_REAL_ESTATE", "OTHER_REAL_ESTATE", "INSURANCE", "RETIREMENT_ALLOWANCE", "LOAN_RECEIVABLE"]);
