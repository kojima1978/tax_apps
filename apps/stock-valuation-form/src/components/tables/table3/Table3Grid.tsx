...
const CELLS: GridCell[] = [
  ...
  // ── 1. 原則的評価方式による価額 ──
  { kind: 'label', text: '１．原則的評価方式による価額', top: 14.36, left: 7.25, width: 3.02, height: 32.62, align: 'center' },
  { kind: 'label', text: '１株当たりの\n価額の計算の\n基となる金額', top: 14.36, left: 10.27, width: 9.07, height: 6.47, fontSize: 7 },
  { kind: 'label', text: '①　類 似 業 種 比 準 価 額\n（第４表の２の㉖、㉘又は㉜の金額）\n（円）', fontSize: 6.5, top: 14.36, left: 19.34, width: 23.45, height: 3.87 },
  { kind: 'label', text: '②　１株当たりの純資産価額\n（第５表の⑪の金額）\n（円）', fontSize: 6.5, top: 14.36, left: 42.79, width: 23.29, height: 3.87 },
  { kind: 'label', text: '③　１株当たりの純資産価額の80％相当額\n（第５表の⑫の記載がある場合のその金額）\n（円）', fontSize: 6.5, top: 14.36, left: 66.08, width: 26.26, height: 3.87 },
  ...
  { kind: 'label', text: '１株当たりの価額\n（円）', top: 20.83, left: 71.6, width: 20.74, height: 2.13, fontSize: 7 },
  // 大会社
  ...
  { kind: 'label', text: '⑦　１株当たりの\n配当金額', fontSize: 7, top: 33.96, left: 24.78, width: 24.49, height: 5.01 },
  ...yenSenInput('J01', 'mod1_div', 'mod1_div_sen', 33.96, 5.01, 49.27, 51.09, 60.15, 61.97, 69.78, 71.6),
  { kind: 'label', text: '⑧　修正後の株式の価額\n（（④、⑤又は⑥）－⑦）　（円）', fontSize: 7, top: 33.96, left: 71.6, width: 20.74, height: 2.42 },
  ...
  { kind: 'label', text: '⑫　修正後の株式の価額\n（④、⑤又は⑥（⑧がある\nときは⑧）＋⑨×⑩）÷\n（１株＋⑪）　（円）', fontSize: 6.5, top: 38.97, left: 71.6, width: 20.74, height: 5.5 },
  { field: '⑫', kind: 'input', readOnly: true, top: 44.47, left: 71.6, width: 20.74, height: 2.51, align: 'right' },
  // ── 2. 配当還元方式による価額 ──
  { kind: 'label', text: '２．配当還元方式による価額', top: 47.18, left: 7.25, width: 3.02, height: 24.1, align: 'center' },
  { kind: 'label', text: '１ 株 当 た り の 資 本 金 等 の 額 、 発 行 済 株 式 数 等', top: 47.18, left: 10.27, width: 82.07, height: 1.85 },
  { kind: 'label', text: '⑬　直前期末の\n資本金等の額\n（千円）', fontSize: 6.5, top: 49.03, left: 10.27, width: 17.05, height: 3.96 },
  { kind: 'label', text: '⑭　直前期末の\n発行済株式数\n（株）', fontSize: 6.5, top: 49.03, left: 27.32, width: 15.47, height: 3.96 },
  { kind: 'label', text: '⑮　直前期末の\n自己株式数\n（株）', fontSize: 6.5, top: 49.03, left: 42.79, width: 15.55, height: 3.96 },
  { kind: 'label', text: '⑯　１株当たりの資本金等の\n額を50円とした場合の発行\n済株式数（⑬÷50円）（株）', fontSize: 6, top: 49.03, left: 58.34, width: 17.37, height: 3.96 },
  { kind: 'label', text: '⑰　１株当たりの\n資本金等の額\n（⑬÷（⑭－⑮））（円）', fontSize: 6, top: 49.03, left: 75.71, width: 16.63, height: 3.96 },
  ...
  { field: '⑯', kind: 'input', readOnly: true, topRightLabel: '株', top: 52.99, left: 58.34, width: 17.37, height: 2.62, align: 'right' },
  { kind: 'cell', codeLabel: 'C06', top: 52.99, left: 75.71, width: 1.81, height: 2.62 },
  { field: '⑰', kind: 'input', readOnly: true, topRightLabel: '円', top: 52.99, left: 77.52, width: 14.82, height: 2.62, align: 'right' },
  // 直前期末以前2年間の配当金額
  ...
  { field: '㉑', kind: 'input', readOnly: true, topRightLabel: '千円', top: 59.6, left: 75.71, width: 16.63, height: 5.19, align: 'right' },
  // ㉒ 1株(50円)当たりの年配当金額
  ...
  { kind: 'label', text: '３．株式に関する権利の評価（１．及び２．に共通）', top: 71.51, left: 7.25, width: 3.02, height: 18.75, align: 'center' },
  // 配当期待権
  ...
  // ── 4. 株式及び株式に関する権利の価額 ──
  { kind: 'label', text: '４．株式及び株式に\n関する権利の価額\n（１．及び２．に共通）', fontSize: 6.5, top: 90.46, left: 7.25, width: 13.9, height: 3.44 },
