...
import { hdr, parseNum } from '../shared';
...
export function Table4Section1({ g, u, treasuryShares }: Props) {
  ...
  return (
    <table className="gov-table" style={{ fontSize: 6, tableLayout: 'fixed', borderBottom: '1.5px solid #000' }}>
      <colgroup>
        <col style={{ width: '15%' }} />
        <col />
        <col />
      ...
      <tbody>
        <tr>
          <td rowSpan={2} style={{ ...hdr, padding: '2px 3px', fontSize: 7, textAlign: 'center', lineHeight: 1.3 }}>
            1.1　1株当たりの資本金<br />等の額等の計算
          </td>
          <td style={{ ...hdr, lineHeight: 1.3, textAlign: 'center' }}>直前期末の<br />資本金等の額</td>
          <td style={{ ...hdr, lineHeight: 1.3, textAlign: 'center' }}>直前期末の<br />発行済株式数</td>
          <td style={{ ...hdr, lineHeight: 1.3, textAlign: 'center' }}>直前期末の<br />自己株式数</td>
          <td style={{ ...hdr, lineHeight: 1.3, textAlign: 'center' }}>1株当たりの資本金等の額<br />（①÷（②−③））</td>
          <td style={{ ...hdr, lineHeight: 1.3, textAlign: 'center' }}>1株当たりの資本金等の額を<br />50円とした場合の発行済株式数<br />（①÷50円）</td>
        </tr>
        <tr style={{ fontSize: 7 }}>
          <td>
