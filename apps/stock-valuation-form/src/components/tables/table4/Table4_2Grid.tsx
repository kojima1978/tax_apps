...
function simBlock(d: number, cfg: BlockCfg): GridCell[] {
  ...
  return [
    // 類似業種名・業種目番号
    { kind: 'label', text: '類 似 業 種', top: t(14.96), left: 13.66, width: 12.21, height: 2.73 },
    { field: `${fp}gyo`, kind: 'input', top: t(14.96), left: 25.87, width: 34.4, height: 2.73, align: 'left' },
    { kind: 'label', text: '業種目番号', top: t(14.96), left: 60.27, width: 13.29, height: 2.73 },
    { kind: 'cell', codeLabel: cfg.aCode === 'G02' ? 'G01' : 'G07', top: t(14.96), left: 73.56, width: 2.0, height: 2.73 },
    { field: `${fp}gyonum`, kind: 'input', top: t(14.96), left: 75.56, width: 17.35, height: 2.73, align: 'left' },
    // 類似業種の株価 ヘッダー
    { kind: 'label', text: '類 似 業 種 の 株 価', top: t(17.69), left: 13.66, width: 79.25, height: 2.0 },
    ...
    { kind: 'label', text: `Ａ\n（${cfg.prices.join('、')}のうち\n最も低いもの）`, fontSize: 6, top: t(19.69), left: 71.76, width: 21.15, height: 5.38 },
    // 月番号
    { field: cfg.months[0], kind: 'input', readOnly: true, topRightLabel: '月', top: t(22.34), left: 11.72, width: 12.41, height: 2.73 },
    { field: cfg.months[1], kind: 'input', readOnly: true, topRightLabel: '月', top: t(22.34), left: 24.13, width: 11.49, height: 2.73 },
    { field: cfg.months[2], kind: 'input', readOnly: true, topRightLabel: '月', top: t(22.34), left: 35.62, width: 13.01, height: 2.73 },
    // 株価
    ...
    { field: `${fp}eD`, kind: 'input', readOnly: true, top: t(37.52), left: 58.38, width: 15.31, height: 2.74, align: 'right' },
    // 比準割合 行
...
const CELLS: GridCell[] = [
  ...
  { kind: 'label', text: '直前期末の翌日から課税\n時期までの間に配当金交\n付の効力が発生した場合', fontSize: 6, top: 78.46, left: 11.72, width: 14.35, height: 4.57, align: 'left' },
  { kind: 'label', text: '１株当たりの配当金額', top: 78.46, left: 26.07, width: 16.8, height: 4.57, fontSize: 7 },
  { kind: 'label', text: '㉗', top: 78.46, left: 42.87, width: 1.93, height: 4.57 },
  { kind: 'cell', codeLabel: 'J07', top: 78.46, left: 44.8, width: 1.9, height: 4.57 },
  { field: 'mod_div', kind: 'input', commaInteger: true, top: 78.46, left: 46.7, width: 15.44, height: 4.57, align: 'right' },
  { kind: 'label', text: '円', top: 78.46, left: 64.1, width: 1.94, height: 4.57, fontSize: 7 },
  { field: 'mod_div_sen', kind: 'input', integerDigits: 2, top: 78.46, left: 66.04, width: 7.65, height: 4.57, align: 'right' },
  { kind: 'label', text: '銭', top: 78.46, left: 73.69, width: 1.89, height: 4.57, fontSize: 7 },
  { kind: 'label', text: '修正比準価額\n（㉖－㉗）（円）', top: 78.46, left: 75.58, width: 17.33, height: 1.6, fontSize: 6.5 },
  { kind: 'label', text: '㉘', top: 80.06, left: 75.58, width: 2.0, height: 3.7 },
  { kind: 'cell', codeLabel: 'C04', top: 80.06, left: 77.58, width: 1.94, height: 3.7 },
  { field: '㉘', kind: 'input', readOnly: true, top: 80.06, left: 79.52, width: 13.39, height: 3.7, align: 'right' },
  ...
  { field: 'mod_pay', kind: 'input', commaInteger: true, top: 83.76, left: 46.7, width: 15.44, height: 2.74, align: 'right' },
  { kind: 'label', text: '円', top: 83.76, left: 64.1, width: 1.94, height: 2.74, fontSize: 7 },
  { kind: 'label', text: '修正比準価額\n㉖（㉘があるときは㉘）\n＋㉙×㉚\n÷（１株＋㉛）（円）', top: 83.76, left: 75.58, width: 17.33, height: 8.21, fontSize: 6 },
  ...
  { field: 'mod_ratio', kind: 'input', top: 86.5, left: 46.7, width: 24.9, height: 2.73, align: 'right' },
  { kind: 'label', text: '株', top: 86.5, left: 71.6, width: 2.09, height: 2.73, fontSize: 7 },
  ...
  { field: 'mod_ratio2', kind: 'input', top: 89.23, left: 46.7, width: 24.9, height: 2.74, align: 'right' },
  { kind: 'label', text: '株', top: 89.23, left: 71.6, width: 2.09, height: 2.74, fontSize: 7 },
...
export function Table4_2Grid({ getField, updateField, onJump }: TableProps) {
  ...
  return <GridForm cells={CELLS} g={g} u={u} formId={T} width="100%" title="第４表の２　類似業種比準価額等の計算明細書（続）" references={REFERENCES} onJump={onJump && ((t) => onJump({ tab: t.tab as TableId, field: t.field }))} />;
}
