...
import { calcTable4 } from './calcTable4';
...
function simBlock(d: number, cfg: BlockCfg): GridCell[] {
  ...
  return [
    ...
    // 株価
    { field: cfg.prices[0], kind: 'input', commaInteger: true, readOnly: true, cornerLabel: cfg.prices[0], highlightWhen: minValueHighlight(cfg.aHighlight, cfg.prices[0]), top: t(25.07), left: 11.72, width: 10.52, height: 2.74, align: 'right' },
    { kind: 'label', text: '円', top: t(25.07), left: 22.24, width: 1.89, height: 2.74, fontSize: 7 },
    { field: cfg.prices[1], kind: 'input', commaInteger: true, readOnly: true, cornerLabel: cfg.prices[1], highlightWhen: minValueHighlight(cfg.aHighlight, cfg.prices[1]), top: t(25.07), left: 24.13, width: 9.59, height: 2.74, align: 'right' },
    { kind: 'label', text: '円', top: t(25.07), left: 33.72, width: 1.9, height: 2.74, fontSize: 7 },
    { field: cfg.prices[2], kind: 'input', commaInteger: true, readOnly: true, cornerLabel: cfg.prices[2], highlightWhen: minValueHighlight(cfg.aHighlight, cfg.prices[2]), top: t(25.07), left: 35.62, width: 11.08, height: 2.74, align: 'right' },
    { kind: 'label', text: '円', top: t(25.07), left: 46.7, width: 1.93, height: 2.74, fontSize: 7 },
    { field: cfg.prices[3], kind: 'input', commaInteger: true, readOnly: true, cornerLabel: cfg.prices[3], highlightWhen: minValueHighlight(cfg.aHighlight, cfg.prices[3]), top: t(25.07), left: 48.63, width: 9.75, height: 2.74, align: 'right' },
    { kind: 'label', text: '円', top: t(25.07), left: 58.38, width: 1.89, height: 2.74, fontSize: 7 },
    { field: cfg.prices[4], kind: 'input', commaInteger: true, readOnly: true, cornerLabel: cfg.prices[4], highlightWhen: minValueHighlight(cfg.aHighlight, cfg.prices[4]), top: t(25.07), left: 60.27, width: 9.59, height: 2.74, align: 'right' },
    ...
    { field: `${fp}sB1`, kind: 'input', commaInteger: true, readOnly: true, top: t(34.79), left: 24.13, width: 5.77, height: 2.73, align: 'right' },
    { kind: 'label', text: '円', top: t(34.79), left: 29.9, width: 1.89, height: 2.73, fontSize: 7 },
    { field: `${fp}sB2`, kind: 'input', readOnly: true, top: t(34.79), left: 31.79, width: 3.83, height: 2.73, align: 'right' },
    ...
    { field: `${fp}sC`, kind: 'input', commaInteger: true, readOnly: true, top: t(34.79), left: 42.87, width: 11.48, height: 2.73, align: 'right' },
    ...
    { field: `${fp}sD`, kind: 'input', commaInteger: true, readOnly: true, top: t(34.79), left: 60.27, width: 13.42, height: 2.73, align: 'right' },
