...
function ratioPriceBlock(dTop: number, n: BlockNums, fp: string): GridCell[] {
  ...
  return [
    ...
    { kind: 'label', text: '１株(50円)当たりの\n年配当金額', top: t(47.93), left: 46.28, width: 10.77, height: 3.08 },
    { kind: 'label', text: '１株(50円)当たりの\n年利益金額', top: t(47.93), left: 56.79, width: 10.77, height: 2.99 },
    { kind: 'label', text: '１株(50円)当たりの\n純資産価額', top: t(48.03), left: 67.29, width: 10.77, height: 2.89 },
    { kind: 'label', text: '評価\n会社', top: t(50.73), left: 39.19, width: 7.23, height: 3.66 },
    { kind: 'label', text: 'Ⓑ', top: t(50.83), left: 46.48, width: 2.73, height: 3.56 },
    { field: `${fp}vB1`, kind: 'input', readOnly: true, topRightLabel: '円', top: t(50.92), left: 48.6, width: 5.05, height: 3.57 },
    { field: `${fp}vB2`, kind: 'input', readOnly: true, topRightLabel: '銭', top: t(50.83), left: 53.38, width: 3.68, height: 3.46 },
    { kind: 'label', text: 'Ⓒ', top: t(50.92), left: 56.79, width: 2.59, height: 3.57 },
    { field: `${fp}vC`, kind: 'input', readOnly: true, topRightLabel: '円', top: t(50.83), left: 59.1, width: 8.46, height: 3.56 },
    { kind: 'label', text: 'Ⓓ', top: t(50.73), left: 67.29, width: 2.59, height: 3.56 },
    { field: `${fp}vD`, kind: 'input', readOnly: true, topRightLabel: '円', top: t(50.83), left: 69.74, width: 8.32, height: 3.66 },
    { kind: 'label', text: '類似\n業種', top: t(54.3), left: 39.46, width: 6.96, height: 3.66 },
    { kind: 'label', text: 'B', top: t(54.3), left: 46.42, width: 2.45, height: 3.56 },
    { field: `${fp}sB1`, kind: 'input', topRightLabel: '円', top: t(54.3), left: 48.74, width: 4.77, height: 3.66 },
    { field: `${fp}sB2`, kind: 'input', topRightLabel: '銭', top: t(54.3), left: 53.24, width: 3.82, height: 3.66 },
    { kind: 'label', text: 'C', top: t(54.39), left: 56.79, width: 2.59, height: 3.57 },
    { field: `${fp}sC`, kind: 'input', topRightLabel: '円', top: t(54.3), left: 59.1, width: 8.46, height: 3.66 },
    { kind: 'label', text: 'D', top: t(54.2), left: 67.29, width: 2.59, height: 3.66 },
    { field: `${fp}sD`, kind: 'input', topRightLabel: '円', top: t(54.2), left: 69.74, width: 8.32, height: 3.66 },
...
const CELLS: GridCell[] = [
  ...
  { field: 'e18', kind: 'input', commaInteger: true, topRightLabel: '千円', top: 31.26, left: 19.42, width: 8.32, height: 2.6 },
  ...
  { field: 'e25', kind: 'input', commaInteger: true, topRightLabel: '千円', top: 33.57, left: 19.42, width: 8.18, height: 2.6 },
  ...
  { field: 'e32', kind: 'input', commaInteger: true, topRightLabel: '千円', top: 35.89, left: 19.28, width: 8.59, height: 2.51 },
  ...
  { kind: 'label', text: '１株(50円)当たりの年利益金額\n（㊁÷⑤又は(㊁＋㋭)÷２÷⑤の金額）', noWrap: true, top: 33.67, left: 68.38, width: 21.55, height: 3.28 },
  ...
  { field: 'n52', kind: 'input', commaInteger: true, topRightLabel: '千円', top: 43.21, left: 19.42, width: 16.5, height: 2.7 },
  { field: 'n53', kind: 'input', commaInteger: true, topRightLabel: '千円', top: 43.21, left: 35.65, width: 16.64, height: 2.7 },
  ...
  { field: '㋷', kind: 'input', commaInteger: true, topRightLabel: '円', top: 50.63, left: 28.96, width: 8.18, height: 2.51 },
  ...
  { field: '㋸', kind: 'input', commaInteger: true, topRightLabel: '円', top: 55.07, left: 28.69, width: 8.46, height: 2.22 },
  { field: '㋦', kind: 'input', commaInteger: true, topRightLabel: '円', top: 52.95, left: 28.55, width: 8.46, height: 2.31 },
  { kind: 'label', text: '前年平均株価', top: 56.99, left: 15.6, width: 13.5, height: 2.41 },
  { field: '㋾', kind: 'input', commaInteger: true, topRightLabel: '円', top: 56.99, left: 28.69, width: 8.46, height: 2.51 },
  { kind: 'label', text: '課税時期の属する月以前\n２年間の平均株価', fontSize: 6, noWrap: true, top: 59.21, left: 15.73, width: 13.23, height: 2.12 },
  { field: '㋻', kind: 'input', commaInteger: true, topRightLabel: '円', top: 59.21, left: 28.55, width: 8.73, height: 2.31 },
  ...
  { field: '㋕', kind: 'input', commaInteger: true, topRightLabel: '円', top: 67.5, left: 28.69, width: 8.32, height: 2.41 },
  ...
  { field: '㋵', kind: 'input', commaInteger: true, topRightLabel: '円', top: 69.72, left: 28.69, width: 8.32, height: 2.12 },
  ...
  { field: '㋟', kind: 'input', commaInteger: true, topRightLabel: '円', top: 71.74, left: 28.69, width: 8.46, height: 2.31 },
  { kind: 'label', text: '前年平均株価', top: 73.96, left: 15.87, width: 12.96, height: 2.22 },
  { field: '㋹', kind: 'input', commaInteger: true, topRightLabel: '円', top: 73.86, left: 28.55, width: 8.46, height: 2.31 },
  { kind: 'label', text: '課税時期の属する月以前\n２年間の平均株価', fontSize: 6, noWrap: true, top: 75.98, left: 15.73, width: 13.09, height: 2.31 },
  { field: '㋞', kind: 'input', commaInteger: true, topRightLabel: '円', top: 75.89, left: 28.55, width: 8.59, height: 2.41 },
...
export function calcTable4(getField: TableProps['getField']) {
  ...
  return { cap4, cap4disp, cap5, i1, i2, i3, v9, v10, b1, b2, Bv, p1, p2, p3, c1, c2, Cv, t1, t2, d1, d2, Dv, A1, A2, e1B, e1C, e1D, e2B, e2C, e2D, r21, r24, p22, p25, v26, v27, v28 };
}
