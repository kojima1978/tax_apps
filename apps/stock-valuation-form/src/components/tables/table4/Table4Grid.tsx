...
function ratioPriceBlock(dTop: number, n: BlockNums, fp: string): GridCell[] {
  ...
  return [
    ...
    { field: `${fp}sB1`, kind: 'input', topRightLabel: '円', top: t(54.3), left: b.valueLeft, width: 4.77, height: 3.66 },
    ...
    { field: `${fp}sC`, kind: 'input', topRightLabel: '円', top: t(54.3), left: c.valueLeft, width: c.valueWidth, height: 3.66 },
    { kind: 'label', text: 'D', top: t(54.2), left: d.left, width: markWidth, height: 3.66 },
    { field: `${fp}sD`, kind: 'input', topRightLabel: '円', top: t(54.2), left: d.valueLeft, width: d.valueWidth, height: 3.66 },
...
const CELLS: GridCell[] = [
  ...
  { field: '㋾', kind: 'input', commaInteger: true, cornerLabel: '㋾', topRightLabel: '円', highlightWhen: minValueHighlight(['㋷', '㋦', '㋸', '㋾', '㋻'], '㋾'), top: 56.99, left: 28.69, width: 8.46, height: 2.51 },
  { kind: 'label', text: '課税時期の属する月以前\n２年間の平均株価', fontSize: 6, noWrap: true, top: 59.21, left: 15.73, width: 13.23, height: 2.12 },
  { field: '㋻', kind: 'input', commaInteger: true, cornerLabel: '㋻', topRightLabel: '円', highlightWhen: minValueHighlight(['㋷', '㋦', '㋸', '㋾', '㋻'], '㋻'), top: 59.21, left: 28.55, width: 8.73, height: 2.31 },
  ...
  { field: '㋞', kind: 'input', commaInteger: true, cornerLabel: '㋞', topRightLabel: '円', highlightWhen: minValueHighlight(['㋕', '㋵', '㋟', '㋹', '㋞'], '㋞'), top: 75.89, left: 28.55, width: 8.59, height: 2.41 },
