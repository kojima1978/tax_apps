...
const CELLS: GridCell[] = [
  ...
  { kind: 'label', text: '④　１株当たりの\n　　資本金等の額\n（①÷（②－③））（円）', fontSize: 7, top: 14.87, left: 63.46, width: 13.82, height: 4.7 },
  { kind: 'label', text: '⑤　１株当たりの資本金等の\n　　額を50円とした場合の発\n　　行済株式数（①÷50円）（株）', fontSize: 6.5, top: 14.87, left: 77.28, width: 15.15, height: 4.7 },
  ...
  ...mi('㋑', '㋑', 27.69, 2.79, 52.1, 67.24, { topRightLabel: '千円' }),
  ...
  ...mi('㋺', '㋺', 30.48, 2.71, 52.1, 67.24, { topRightLabel: '千円' }),
  ...
  ...mi('㋩', '㋩', 33.19, 2.76, 52.1, 67.24, { topRightLabel: '千円' }),
  // ⑨=(㋑+㋺)÷2（上半分）、⑩=(㋺+㋩)÷2（下半分）
  ...
  { field: '⑨', kind: 'input', readOnly: true, topRightLabel: '千円', top: 29.09, left: 69.14, width: 23.29, height: 2.73, align: 'right' },
  ...
  { field: '⑩', kind: 'input', readOnly: true, topRightLabel: '千円', top: 33.22, left: 69.14, width: 23.29, height: 2.73, align: 'right' },
  // === 年利益金額ブロック ===
  { kind: 'label', text: '１株（50円）当たりの年利益金額', top: 35.95, left: 9.67, width: 3.38, height: 13.71 },
  { kind: 'label', text: '直 前 期 末 以 前 ２ （ ３ ） 年 間 の 利 益 金 額 （ 千 円 ）', top: 35.95, left: 13.05, width: 79.38, height: 2.4 },
  ...
  ...mi('㊁', '㊁', 41.54, 2.71, 81.06, 92.43, { topRightLabel: '千円' }),
  ...
  ...mi('㋭', '㋭', 44.25, 2.7, 81.06, 92.43, { topRightLabel: '千円' }),
  ...
  ...mi('㋬', '㋬', 46.95, 2.71, 81.06, 92.43, { topRightLabel: '千円' }),
  // === 純資産価額ブロック ===
  { kind: 'label', text: '１株（50円）当たりの純資産価額', top: 49.66, left: 9.67, width: 3.38, height: 10.62 },
  { kind: 'label', text: '直 前 期 末 （ 直 前 々 期 末 ） の 純 資 産 価 額 （ 千 円 ）', top: 49.66, left: 13.05, width: 79.38, height: 2.45 },
  ...
  ...mi('㋣', '㋣', 54.9, 2.68, 69.14, 92.43, { topRightLabel: '千円' }),
  ...
  ...mi('㋠', '㋠', 57.58, 2.7, 69.14, 92.43, { topRightLabel: '千円' }),
  ...
  { kind: 'label', text: 'Ⓑ1', top: 64.53, left: 15.51, width: 2.34, height: 3.7 },
  ...
  { kind: 'label', text: 'Ⓒ1', top: 64.53, left: 47.7, width: 2.5, height: 3.7 },
  ...
  { kind: 'label', text: 'D1', top: 64.53, left: 72.93, width: 2.45, height: 3.7 },
  ...
  { kind: 'label', text: 'Ⓑ2', top: 68.23, left: 15.51, width: 2.34, height: 3.68 },
  ...
  { kind: 'label', text: 'Ⓒ2', top: 68.23, left: 47.7, width: 2.5, height: 3.68 },
  ...
  { kind: 'label', text: 'D2', top: 68.23, left: 72.93, width: 2.45, height: 3.68 },
