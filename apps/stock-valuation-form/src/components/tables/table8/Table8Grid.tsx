...
// ── 端数処理 ──
const CORPORATE_TAX_RATE = 0.37;                 // 評価差額に対する法人税額等相当額（37％）
...
function buildCells(cls: S1Class): GridCell[] {
  ...
  { kind: 'label', text: '修正後の類似業種比準価額\n（第７表の㉔ 、㉕又は㉖の金額）', top: 38.01, left: 26.37, width: 20.59, height: 4.34 },
  { kind: 'label', text: '修正後の１株当たりの純資産価額\n（相続税評価額）\n（⑪の金額）', top: 38.1, left: 46.69, width: 20.59, height: 4.24 },
  { field: '⑫', kind: 'input', readOnly: true, cornerLabel: '⑫', topRightLabel: '円', top: 42.25, left: 26.37, width: 20.59, height: 4.14 },
  { field: '⑬', kind: 'input', readOnly: true, cornerLabel: '⑬', topRightLabel: '円', top: 42.06, left: 46.69, width: 20.46, height: 4.34 },
  ...
  { kind: 'label', text: '次のうちいずれか低い方の金額\nイ　⑬の金額\nロ　（⑫の金額×0.25）＋（⑬の金額×0.75）', top: 48.9, left: 21.74, width: 50.19, height: 5.3 },
  { field: '⑭', kind: 'input', readOnly: true, highlightWhen: () => cls.hijun1, topRightLabel: '円', top: 48.9, left: 71.65, width: 18.68, height: 5.3 },
  ...
  { field: '⑮', kind: 'input', readOnly: true, highlightWhen: () => cls.big, topRightLabel: '円', top: 54.01, left: 71.65, width: 18.82, height: 5.1 },
  ...
  { field: '⑯', kind: 'input', readOnly: true, highlightWhen: () => cls.mid, topRightLabel: '円', top: 58.92, left: 71.79, width: 18.55, height: 5.01 },
  ...
  { field: '⑰', kind: 'input', readOnly: true, highlightWhen: () => cls.small, topRightLabel: '円', top: 63.74, left: 71.79, width: 18.55, height: 5.4 },
  // ── 2. S2の金額 ──
  ...
  { field: '㉔', kind: 'input', readOnly: true, cornerLabel: '㉔', topRightLabel: '円', top: 80.71, left: 50.38, width: 20.46, height: 4.63 },
  // ── 3. 株式等保有特定会社の株式の価額 ──
  ...
  { field: '㉕', kind: 'input', readOnly: true, cornerLabel: '㉕', topRightLabel: '円', top: 89.67, left: 21.6, width: 22.91, height: 4.53 },
  { field: '㉖', kind: 'input', readOnly: true, cornerLabel: '㉖', topRightLabel: '円', top: 89.77, left: 44.37, width: 22.78, height: 4.53 },
  { field: '㉗', kind: 'input', readOnly: true, cornerLabel: '㉗', topRightLabel: '円', top: 89.67, left: 67.01, width: 23.32, height: 4.53 },
  ];
}
