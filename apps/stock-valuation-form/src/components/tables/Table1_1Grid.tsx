...
const CELLS: GridCell[] = [
  ...
  { kind: 'label', text: '課 税 時 期', top: 16.9, left: 8.1, width: 13.09, height: 5.2 },
  { kind: 'label', text: '直 前 期', top: 21.81, left: 8.1, width: 13.23, height: 5.11 },
  ...
  { field: 'f14', kind: 'input', top: 17.09, left: 21.05, width: 29.87, height: 5.01 },
  { field: 'f15', kind: 'input', top: 22.01, left: 20.92, width: 29.87, height: 4.92 },
  // ── 会社情報ヘッダー（右：本店所在地・事業内容） ──
  { kind: 'label', text: '本 店 の所 在 地', top: 8.61, left: 50.65, width: 8.86, height: 5.2 },
  { kind: 'label', text: '事　　業内　　容', top: 13.81, left: 50.65, width: 8.86, height: 13.01 },
  ...
  { kind: 'label', text: '取 引 金 額の 構 成 比', top: 13.72, left: 84.88, width: 8.59, height: 3.28 },
