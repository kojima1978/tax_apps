...
const CELLS: GridCell[] = [
  ...
  { kind: 'cell', top: 24.42, left: 17.69, width: 1.81, height: 0.99 },
  { kind: 'label', text: '元　号', top: 24.42, left: 19.5, width: 5.44, height: 0.99, fontSize: 7 },
  ...
  { kind: 'label', text: '役　職\nコード', top: 35.78, left: X.gCode, width: 5.44, height: 2.54, fontSize: 7.5 },
  { kind: 'label', text: '会社における役職名', top: 35.78, left: X.roleECode, width: 19.95, height: 2.54 },
  ...
  { kind: 'label', text: '続　柄\nコード', top: 38.32, left: X.eCode, width: 5.44, height: 2.56, fontSize: 7.5 },
  { kind: 'label', text: '続　　　柄', top: 38.32, left: X.relECode, width: 16.31, height: 2.56 },
  { kind: 'label', text: '株式種類\nコード', top: 38.32, left: X.gCode, width: 5.44, height: 2.56, fontSize: 7.5 },
  { kind: 'label', text: '株 式 の 種 類', top: 38.32, left: X.roleECode, width: 19.95, height: 2.56 },
  ...
  { kind: 'label', text: '①', top: 69.4, left: X.numCode1, width: 1.81, height: 1.45, fontSize: 7.5 },
  { kind: 'label', text: '議 決 権 数', top: 69.4, left: X.num1, width: 12.69, height: 1.45, fontSize: 7.5 },
  ...
  { kind: 'label', text: '②', top: 69.4, left: X.numCode2, width: 1.82, height: 1.45, fontSize: 7.5 },
  { kind: 'label', text: '議決権割合（①/⑥）', top: 69.4, left: X.num2, width: 12.77, height: 1.45, fontSize: 7.5 },
  ...
  { kind: 'label', text: '③', top: 73.45, left: X.numCode1, width: 1.81, height: 1.48, fontSize: 7.5 },
  { kind: 'label', text: '議 決 権 数', top: 73.45, left: X.num1, width: 12.69, height: 1.48, fontSize: 7.5 },
  ...
  { kind: 'label', text: '④', top: 73.45, left: X.numCode2, width: 1.82, height: 1.48, fontSize: 7.5 },
  { kind: 'label', text: '議決権割合（③/⑥）', top: 73.45, left: X.num2, width: 12.77, height: 1.48, fontSize: 7.5 },
  ...
  { kind: 'label', text: '⑤', top: 77.52, left: X.numCode1, width: 1.81, height: 1.03, fontSize: 7.5 },
  { kind: 'label', text: '発行済株式数', top: 77.52, left: X.num1, width: 12.69, height: 1.03, fontSize: 7.5 },
  ...
  { kind: 'label', text: '⑥', top: 81.14, left: X.numCode1, width: 1.81, height: 1.05, fontSize: 7.5 },
  { kind: 'label', text: '議決権の総数', top: 81.14, left: X.num1, width: 12.69, height: 1.05, fontSize: 7.5 },
