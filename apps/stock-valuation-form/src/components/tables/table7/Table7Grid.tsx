...
const BLOCK1_CALC: GridCell[] = [
  ...
  { field: '㊁', kind: 'input', topRightLabel: '円', top: 49.77, left: 28.83, width: 8.18, height: 2.22 },
  { field: 'f68', kind: 'input', topRightLabel: '月', top: 51.98, left: 24.05, width: 4.91, height: 2.02 },
  { field: '㋭', kind: 'input', topRightLabel: '円', top: 51.89, left: 28.83, width: 8.32, height: 2.12 },
  { field: 'f70', kind: 'input', topRightLabel: '月', top: 54.01, left: 24.05, width: 4.91, height: 2.02 },
  { field: '㋬', kind: 'input', topRightLabel: '円', top: 53.91, left: 28.83, width: 8.32, height: 2.12 },
  ...
  { field: '㋣', kind: 'input', topRightLabel: '円', top: 55.93, left: 28.83, width: 8.32, height: 2.31 },
  { field: '㋠', kind: 'input', topRightLabel: '円', top: 58.15, left: 28.83, width: 8.46, height: 2.12 },
  { field: '⑱', kind: 'input', readOnly: true, topRightLabel: '円', top: 60.27, left: 28.96, width: 8.18, height: 3.37 },
  // 比準割合の計算
  ...
  { field: 'f103', kind: 'input', readOnly: true, top: 49.77, left: 48.88, width: 4.91, height: 3.47 },
  ...
  { field: 'f106', kind: 'input', readOnly: true, top: 49.77, left: 59.65, width: 8.46, height: 3.57 },
  { kind: 'label', text: '⑰', top: 49.77, left: 67.83, width: 2.73, height: 3.57 },
  { field: 'f108', kind: 'input', readOnly: true, top: 49.77, left: 70.29, width: 8.59, height: 3.57 },
  ...
  { field: '⑲', kind: 'input', readOnly: true, top: 60.08, left: 66.88, width: 12, height: 3.66 },
  // 比準価額
  { field: '⑳', kind: 'input', readOnly: true, top: 60.27, left: 78.74, width: 7.36, height: 3.47 },
