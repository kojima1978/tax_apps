...
const CELLS: GridCell[] = [
  ...
  { kind: 'cell', text: '1株当たりの比準価額', ariaLabel: '1株当たりの比準価額', semanticRole: 'group', groupBorder: false, top: 71.71, left: 9.75, width: 82.55, height: 4.61 },
  { kind: 'cell', text: '比準価額の修正', ariaLabel: '比準価額の修正', semanticRole: 'group', groupBorder: false, top: 76.32, left: 9.75, width: 82.55, height: 12.97 },
  ...
  { kind: 'label', text: '１．S１の金額（続）', semanticRole: 'columnheader', top: 14.47, left: 7.33, width: 2.42, height: 74.82, align: 'center' },
  { kind: 'label', text: '１株（50円）当たりの比準価額の計算', semanticRole: 'columnheader', top: 14.47, left: 9.75, width: 2.3, height: 57.24, align: 'center' },
  ...simBlock(YS1, BLOCK1),
  ...simBlock(YS2, BLOCK2),
  // 1株当たりの比準価額 ㉔
  { kind: 'label', text: '１株当たりの比準価額', semanticRole: 'columnheader', top: 71.71, left: 9.75, width: 16.84, height: 4.61 },
  ...
  { kind: 'label', text: '比準価額', bottomLabel: '（円）', bottomLabelAlign: 'right', top: 71.71, left: 75.83, width: 16.47, height: 1.42, fontSize: 7 },
  ...
  // 比準価額の修正
  { kind: 'label', text: '比 準 価 額 の 修 正', semanticRole: 'columnheader', top: 76.32, left: 9.75, width: 2.3, height: 12.97, align: 'center' },
  ...
  { kind: 'label', text: '㉕', top: 76.32, left: 42.95, width: 1.81, height: 5.08, align: 'center' },
  ...
  { kind: 'label', text: '円', top: 76.32, left: 64.79, width: 1.85, height: 5.08, fontSize: 7, align: 'center' },
  { field: 'mod_div_sen', kind: 'input', integerDigits: 2, top: 76.32, left: 66.64, width: 7.33, height: 5.08, align: 'right' },
  { kind: 'label', text: '銭', top: 76.32, left: 73.97, width: 1.86, height: 5.08, fontSize: 7, align: 'center' },
  { kind: 'label', text: '修正比準価額\n（㉔－㉕）', bottomLabel: '（円）', bottomLabelAlign: 'right', top: 76.32, left: 75.83, width: 16.47, height: 2.45, fontSize: 6.5 },
  ...
  { kind: 'label', text: '修正比準価額', titledFraction: { titleLines: ['修正比準価額'], numeratorLines: ['㉔（㉖があるときは㉖）＋㉗×㉘'], denominator: '１株＋㉙' }, bottomLabel: '（円）', bottomLabelAlign: 'right', top: 81.4, left: 75.83, width: 16.47, height: 5.24, fontSize: 6 },
