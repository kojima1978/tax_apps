...
const CELLS: GridCell[] = [
  ...
  // ── 受取配当金等収受割合の計算 ──
  { kind: 'label', text: '受 取 配 当 金 等 収 受 割 合 の 計 算 （ 千 円 ）', top: 15.1, left: 9.99, width: 82.03, height: 2.51 },
  { kind: 'label', text: '受取配当金等収受割合\n（㋑÷（㋑＋㋺））\n※少数点以下３位未満切り捨て', fontSize: 6.5, top: 17.61, left: 72.56, width: 19.46, height: 3.93 },
  ...
  // ── Ⓑ－ⓑの金額 ──
  { kind: 'label', text: 'Ⓑ　　－　　ⓑ　　の　　金　　額', top: 28.23, left: 9.99, width: 82.03, height: 2.51 },
  { kind: 'cell', diagonal: 'tlbr', top: 30.74, left: 72.56, width: 19.46, height: 7.29 },
  { kind: 'label', text: '③　１株（50円）当たりの\n　　年配当金額（第４表の１のⒷ）', fontSize: 6.5, top: 30.74, left: 9.99, width: 23.81, height: 3.96 },
  { kind: 'label', text: '④　ⓑ の 金 額\n　　（③×㋩）', fontSize: 6.5, top: 30.74, left: 33.8, width: 19.42, height: 3.96 },
  { kind: 'label', text: '⑤　Ⓑ － ⓑ の 金 額\n　　（③－④）', fontSize: 6.5, top: 30.74, left: 53.22, width: 19.34, height: 3.96 },
  ...yenSen('', '③', 'f23', 34.7, 3.33, 9.99, 9.99, 24.05, 25.99, 31.83, 33.8),
  ...yenSen('', '④', 'f25', 34.7, 3.33, 33.8, 33.8, 43.55, 45.49, 51.31, 53.22),
  ...yenSen('J01', '⑤', 'f27', 34.7, 3.33, 53.22, 55.14, 62.89, 64.83, 70.63, 72.56),
  // ── Ⓒ－ⓒの金額 ──
  { kind: 'label', text: 'Ⓒ　　－　　ⓒ　　の　　金　　額', top: 38.03, left: 9.99, width: 82.03, height: 2.51 },
  { kind: 'cell', diagonal: 'tlbr', top: 40.54, left: 72.56, width: 19.46, height: 7.21 },
  { kind: 'label', text: '⑥　１株（50円）当たりの\n　　年利益金額（第４表の１のⒸ）', fontSize: 6.5, top: 40.54, left: 9.99, width: 23.81, height: 3.85 },
  { kind: 'label', text: '⑦　ⓒ の 金 額\n　　（⑥×㋩）', fontSize: 6.5, top: 40.54, left: 33.8, width: 19.42, height: 3.85 },
  { kind: 'label', text: '⑧　Ⓒ － ⓒ の 金 額\n　　（⑥－⑦）', fontSize: 6.5, top: 40.54, left: 53.22, width: 19.34, height: 3.85 },
  { field: '⑥', kind: 'input', readOnly: true, top: 44.39, left: 9.99, width: 21.84, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 44.39, left: 31.83, width: 1.97, height: 3.36, fontSize: 7 },
  { field: '⑦', kind: 'input', readOnly: true, top: 44.39, left: 33.8, width: 17.51, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 44.39, left: 51.31, width: 1.91, height: 3.36, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G05', top: 44.39, left: 53.22, width: 1.92, height: 3.36 },
  { field: '⑧', kind: 'input', readOnly: true, top: 44.39, left: 55.14, width: 15.49, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 44.39, left: 70.63, width: 1.93, height: 3.36, fontSize: 7 },
  // ── Ⓓ－ⓓの金額 ──
  ...
  { kind: 'label', text: '⑨　１株（50円）当たりの純資\n　　産価額（第４表の１のⒹ）', fontSize: 6.5, top: 50.26, left: 14.38, width: 19.42, height: 4.44 },
  { kind: 'label', text: '⑩　直前期末の株式等の\n　　帳簿価額の合計額', fontSize: 6.5, top: 50.26, left: 33.8, width: 19.42, height: 4.44 },
  { kind: 'label', text: '⑪　直前期末の総資産価額\n　　（帳 簿 価 額）', fontSize: 6.5, top: 50.26, left: 53.22, width: 19.34, height: 4.44 },
  { kind: 'label', text: '⑫　（イ）の金額\n　　（⑨×（⑩÷⑪））', fontSize: 6.5, top: 50.26, left: 72.56, width: 19.34, height: 4.44 },
  { field: '⑨', kind: 'input', readOnly: true, top: 54.7, left: 14.38, width: 17.45, height: 3.33, align: 'right' },
  { kind: 'label', text: '円', top: 54.7, left: 31.83, width: 1.97, height: 3.33, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G06', top: 54.7, left: 33.8, width: 1.91, height: 3.33 },
  { field: '⑩', kind: 'input', readOnly: true, jumpTo: { tab: 'table5', field: 'ロ', hint: 'クリックで転記元（第５表の㋺・株式等の帳簿価額の合計額）へ移動します' }, top: 54.7, left: 35.71, width: 15.6, height: 3.33, align: 'right' },
  { kind: 'label', text: '千円', forceVertical: true, align: 'center', top: 54.7, left: 51.31, width: 1.91, height: 3.33, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G07', top: 54.7, left: 53.22, width: 1.92, height: 3.33 },
  { field: '⑪', kind: 'input', commaInteger: true, top: 54.7, left: 55.14, width: 15.49, height: 3.33, align: 'right' },
  { kind: 'label', text: '千円', forceVertical: true, align: 'center', top: 54.7, left: 70.63, width: 1.93, height: 3.33, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G08', top: 54.7, left: 72.56, width: 1.94, height: 3.33 },
  { field: '⑫', kind: 'input', readOnly: true, top: 54.7, left: 74.5, width: 15.46, height: 3.33, align: 'right' },
  { kind: 'label', text: '円', top: 54.7, left: 89.96, width: 1.94, height: 3.33, fontSize: 7 },
  { kind: 'label', text: '（ロ）\nの金額', fontSize: 6.5, top: 58.03, left: 9.99, width: 4.39, height: 8.29 },
  { kind: 'label', text: '⑬　利益積立金額\n　　（第４表の１の⑱の「直前期」欄の金額）', fontSize: 6.5, top: 58.03, left: 14.38, width: 29.17, height: 4.96 },
  { kind: 'label', text: '⑭　１株当たりの資本金等の額を50円とした場合\n　　の発行済株式数（第４表の１の⑤の株式数）', fontSize: 6.5, top: 58.03, left: 43.55, width: 29.01, height: 4.96 },
  { kind: 'label', text: '⑮　（ロ）の金額\n　　（（⑬÷⑭）×㋩）', fontSize: 6.5, top: 58.03, left: 72.56, width: 19.34, height: 4.96 },
  { field: '⑬', kind: 'input', readOnly: true, top: 62.99, left: 14.38, width: 27.08, height: 3.33, align: 'right' },
  { kind: 'label', text: '千円', forceVertical: true, align: 'center', top: 62.99, left: 41.46, width: 2.09, height: 3.33, fontSize: 7 },
  { field: '⑭', kind: 'input', readOnly: true, top: 62.99, left: 43.55, width: 27.08, height: 3.33, align: 'right' },
  { kind: 'label', text: '株', top: 62.99, left: 70.63, width: 1.93, height: 3.33, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G09', top: 62.99, left: 72.56, width: 1.94, height: 3.33 },
  { field: '⑮', kind: 'input', readOnly: true, top: 62.99, left: 74.5, width: 15.46, height: 3.33, align: 'right' },
  { kind: 'label', text: '円', top: 62.99, left: 89.96, width: 1.94, height: 3.33, fontSize: 7 },
  { kind: 'label', text: '⑯　ⓓの金額（⑫＋⑮）', fontSize: 6.5, top: 66.32, left: 9.99, width: 23.81, height: 4.11 },
  { kind: 'label', text: '⑰　Ⓓ－ⓓの金額（⑨－⑯）', fontSize: 6.5, top: 66.32, left: 33.8, width: 19.54, height: 4.11 },
  ...
  { field: '⑯', kind: 'input', readOnly: true, top: 70.43, left: 9.99, width: 21.84, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 70.43, left: 31.83, width: 1.97, height: 3.36, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G10', top: 70.43, left: 33.8, width: 1.91, height: 3.36 },
  { field: '⑰', kind: 'input', readOnly: true, top: 70.43, left: 35.71, width: 15.6, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 70.43, left: 51.31, width: 2.03, height: 3.36, fontSize: 7 },
];
