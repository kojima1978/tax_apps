...
const CELLS: GridCell[] = [
  ...
  { field: '⑥', kind: 'input', readOnly: true, top: 44.39, left: 9.99, width: 19.86, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 44.39, left: 29.85, width: 1.94, height: 3.36, fontSize: 7 },
  { field: '⑦', kind: 'input', readOnly: true, top: 44.39, left: 31.79, width: 17.56, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 44.39, left: 49.35, width: 1.94, height: 3.36, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G05', top: 44.39, left: 51.29, width: 1.93, height: 3.36 },
  { field: '⑧', kind: 'input', readOnly: true, top: 44.39, left: 53.22, width: 17.41, height: 3.36, align: 'right' },
  ...
  { kind: 'label', text: '千円', forceVertical: true, align: 'center', top: 54.7, left: 68.7, width: 1.93, height: 3.33, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G08', top: 54.7, left: 70.63, width: 1.93, height: 3.33 },
  { field: '⑫', kind: 'input', readOnly: true, top: 54.7, left: 72.56, width: 17.4, height: 3.33, align: 'right' },
  ...
  { field: '⑬', kind: 'input', readOnly: true, top: 62.99, left: 14.38, width: 34.97, height: 3.33, align: 'right' },
  { kind: 'label', text: '千円', forceVertical: true, align: 'center', top: 62.99, left: 49.35, width: 1.94, height: 3.33, fontSize: 7 },
  { field: '⑭', kind: 'input', readOnly: true, top: 62.99, left: 51.29, width: 17.41, height: 3.33, align: 'right' },
  { kind: 'label', text: '株', top: 62.99, left: 68.7, width: 1.93, height: 3.33, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G09', top: 62.99, left: 70.63, width: 1.93, height: 3.33 },
  { field: '⑮', kind: 'input', readOnly: true, top: 62.99, left: 72.56, width: 17.4, height: 3.33, align: 'right' },
  ...
  { field: '⑯', kind: 'input', readOnly: true, top: 70.43, left: 9.99, width: 19.86, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 70.43, left: 29.85, width: 1.94, height: 3.36, fontSize: 7 },
  { kind: 'cell', codeLabel: 'G10', top: 70.43, left: 31.79, width: 1.93, height: 3.36 },
  { field: '⑰', kind: 'input', readOnly: true, top: 70.43, left: 33.72, width: 17.68, height: 3.36, align: 'right' },
  { kind: 'label', text: '円', top: 70.43, left: 51.4, width: 1.94, height: 3.36, fontSize: 7 },
];
