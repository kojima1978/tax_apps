...
function buildCells(c: ReturnType<typeof calcTable2>): GridCell[] {
  ...
  return [
    ...
    { kind: 'label', text: '判　　定　　要　　素', top: 35.81, left: 15.51, width: 78.08, height: 1.97 },
    ...
    { kind: 'label', text: '会 社 の 規 模 の 判 定', top: 37.78, left: 69.26, width: 24.33, height: 1.72 },
    { kind: 'label', text: '大　会　社', top: 39.5, left: 69.26, width: 7.81, height: 2.61 },
    { kind: 'label', text: '中　会　社', top: 39.5, left: 77.07, width: 8.63, height: 2.61 },
    { kind: 'label', text: '小　会　社', top: 39.5, left: 85.7, width: 7.89, height: 2.61 },
    { kind: 'cell', codeLabel: 'G05', top: 42.11, left: 69.26, width: 2.58, height: 2.65 },
    { field: 'b_G05', kind: 'input', readOnly: true, ariaLabel: 'G05 大会社（該当時は１）', highlightWhen: () => flags['b_G05'] === true, top: 42.11, left: 71.84, width: 5.23, height: 2.65, align: 'center' },
    { kind: 'cell', codeLabel: 'G06', top: 42.11, left: 77.07, width: 2.58, height: 2.65 },
    { field: 'b_G06', kind: 'input', readOnly: true, ariaLabel: 'G06 中会社（該当時は１）', highlightWhen: () => flags['b_G06'] === true, top: 42.11, left: 79.65, width: 6.05, height: 2.65, align: 'center' },
    { kind: 'cell', codeLabel: 'G07', top: 42.11, left: 85.7, width: 2.58, height: 2.65 },
    { field: 'b_G07', kind: 'input', readOnly: true, ariaLabel: 'G07 小会社（該当時は１）', highlightWhen: () => flags['b_G07'] === true, top: 42.11, left: 88.28, width: 5.31, height: 2.65, align: 'center' },
    // 判定基準（会社規模×⑥の割合）
    ...
    { kind: 'label', text: '元　号', top: 63.08, left: 21.39, width: 8.87, height: 1.45, fontSize: 7 },
    ...
    { kind: 'label', text: 'で　あ　る', highlightWhen: () => j.s4b === true, top: 72.48, left: 66.92, width: 13.55, height: 1.48 },
    { kind: 'label', text: 'で　な　い', highlightWhen: () => j.s4b === false, top: 72.48, left: 80.47, width: 13.12, height: 1.48 },
    { kind: 'label', text: '判　　定', top: 73.96, left: 61.36, width: 5.46, height: 2.54 },
    ...jc(73.96, 2.54, 'G18', '該　　当', 66.82, 69.26, 71.84, 80.47),
    ...jc(73.96, 2.54, 'G19', '非　該　当', 80.47, 83.12, 85.7, 93.59),
