...
const CELLS: GridCell[] = [
  ...
  { field: 'f8', kind: 'input', top: 78.49, left: 8.92, width: 85.65, height: 13.4, align: 'left' },
  // ── 判定（大会社/中会社Lの割合/小会社） ──
  ...
  { field: 'f22', kind: 'input', commaInteger: true, rightLabel: '千円', top: 13.81, left: 25.14, width: 20.73, height: 7.71 },
  { kind: 'label', text: '直前期末以前１年間の取引金額', top: 21.34, left: 11.23, width: 14.18, height: 7.9 },
  { field: 'f24', kind: 'input', commaInteger: true, rightLabel: '千円', top: 21.33, left: 25.28, width: 20.46, height: 7.81 },
  ...
  { field: 'f28', kind: 'input', rightLabel: '人', top: 13.81, left: 60.47, width: 33.96, height: 15.42 },
  // ── 判定基準（マトリクス） ──
  ...
  // 中会社 0.90 行
  { kind: 'label', text: '４億円以上 20億円未満', highlightWhen: assetHL('卸売業', 3), top: 47.55, left: 11.37, width: 9.96, height: 4.92 },
  { kind: 'label', text: '５億円以上 15億円未満', highlightWhen: assetHL('小売・サービス業', 3), top: 47.45, left: 21.05, width: 10.23, height: 5.01 },
  { kind: 'label', text: '５億円以上 15億円未満', highlightWhen: assetHL('その他', 3), top: 47.36, left: 31.15, width: 9.96, height: 5.2 },
  { kind: 'label', text: '35　人　超', highlightWhen: empHL('over35'), top: 47.45, left: 40.83, width: 11.73, height: 5.01 },
  { kind: 'label', text: '７億円以上30億円未満', highlightWhen: txHL('卸売業', 3), top: 47.45, left: 52.28, width: 9.96, height: 5.01 },
  { kind: 'label', text: '５億円以上20億円未満', highlightWhen: txHL('小売・サービス業', 3), top: 47.36, left: 61.97, width: 9.82, height: 5.11 },
  { kind: 'label', text: '４億円以上15億円未満', highlightWhen: txHL('その他', 3), top: 47.45, left: 71.65, width: 10.5, height: 5.01 },
  { kind: 'label', text: '0.90', highlightWhen: resHL(3), top: 47.45, left: 82.02, width: 9.96, height: 5.11 },
  // 中会社 0.75 行
  { kind: 'label', text: '２億円以上４億円未満', highlightWhen: assetHL('卸売業', 2), top: 52.37, left: 11.23, width: 10.09, height: 4.92 },
  { kind: 'label', text: ' 2億5,000万円以上５億円未満', highlightWhen: assetHL('小売・サービス業', 2), top: 52.37, left: 21.05, width: 10.23, height: 5.01 },
  { kind: 'label', text: '2億5,000万円以上５億円未満', highlightWhen: assetHL('その他', 2), top: 52.37, left: 31.15, width: 10.09, height: 5.01 },
  { kind: 'label', text: '20　人　超 35 人 以 下', highlightWhen: empHL('b075'), top: 52.37, left: 40.83, width: 11.73, height: 5.01 },
  { kind: 'label', text: '3億5,000万円以上７億円未満', highlightWhen: txHL('卸売業', 2), top: 52.37, left: 52.42, width: 9.82, height: 5.01 },
  { kind: 'label', text: '2億5,000万円以上５億円未満', highlightWhen: txHL('小売・サービス業', 2), top: 52.27, left: 61.97, width: 9.96, height: 5.2 },
  { kind: 'label', text: '２億円以上４億円未満', highlightWhen: txHL('その他', 2), top: 52.18, left: 71.65, width: 10.64, height: 5.2 },
  ...
  { kind: 'label', text: '7,000万円以上 2億円未満', highlightWhen: assetHL('卸売業', 1), top: 57.38, left: 11.23, width: 10.09, height: 4.92 },
  { kind: 'label', text: '4,000万円以上 2億5,000万円未満', highlightWhen: assetHL('小売・サービス業', 1), top: 57.38, left: 21.05, width: 10.23, height: 4.92 },
  { kind: 'label', text: '5,000万円以上 2億5,000万円未満', highlightWhen: assetHL('その他', 1), top: 57.38, left: 31.15, width: 10.09, height: 4.92 },
  { kind: 'label', text: '5　人　超 20 人 以 下', highlightWhen: empHL('b060'), top: 57.38, left: 40.83, width: 11.73, height: 4.92 },
  { kind: 'label', text: '2億円以上 3億5,000万円未満', highlightWhen: txHL('卸売業', 1), top: 57.38, left: 52.42, width: 9.82, height: 4.92 },
  { kind: 'label', text: '6,000万円以上 2億5,000万円未満', highlightWhen: txHL('小売・サービス業', 1), top: 57.38, left: 61.97, width: 9.96, height: 4.92 },
  { kind: 'label', text: '8,000万円以上 2億円未満', highlightWhen: txHL('その他', 1), top: 57.38, left: 71.65, width: 10.64, height: 4.92 },
  ...
  // 脚注
  { kind: 'label', text: '・「会社規模とＬの割合（中会社）の区分」欄は、チ欄の区分（「総資産価額（帳簿価額）」と「従業員数」とのいずれか下位の区分）とリ欄（取引金額）の区分とのいずれか上位の区分により判定します。', top: 64.8, left: 11.23, width: 83.19, height: 3.66, align: 'left' },
];
...
export function Table1_2Grid({ getField, updateField }: TableProps) {
  ...
  const toolbar = (
    <label className="no-print" style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, whiteSpace: 'nowrap' }}>
      業種区分：
      <select value={g('gyoshu')} onChange={(e) => u('gyoshu', e.target.value)} style={{ fontSize: 11, padding: '1px 2px' }}>
  ...
  return <GridForm cells={CELLS} g={g} u={u} width="100%" title="第１表の２　評価上の株主の判定及び会社規模の判定の明細書（続）" toolbar={toolbar} references={REFERENCES} />;
}
