...
const ActionButtons = ({ canCalculate, hasResult, onCalculate, onClear, onLoadMock }: ActionButtonsProps) => {
    ...
    return (
        <div className="flex gap-3 no-print">
            ...
            {onLoadMock && (
                <button
                    className="bg-white text-emerald-700 border border-emerald-300 py-3 px-4 rounded font-semibold cursor-pointer whitespace-nowrap transition-colors hover:bg-emerald-50 hover:border-emerald-400"
                    onClick={onLoadMock}
                >
                    サンプル
                </button>
