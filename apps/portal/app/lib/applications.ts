...
import {
  ...
  Clock, CreditCard, FileCheck, FileSpreadsheet, FileText, Gift, Package, Receipt, ScrollText, Shield, TrendingUp,
} from 'lucide-react';
...
export const applications: Application[] = [
  ...
  { title: '譲渡所得税計算', description: '不動産・株式等の譲渡にかかる税額を試算', url: '/capital-gains-calc/', icon: TrendingUp, category: '計算・評価' },
  ...
  { title: '相続税の申告書', description: '第1表・第1表（続）の作成・印刷', url: '/inheritance-tax-form/', icon: ScrollText, category: '計算・評価' },
