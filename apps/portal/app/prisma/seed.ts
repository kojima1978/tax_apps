...
const apps = [
  // 相続税関連
  { title: '相続税計算', description: '相続税のシミュレーション計算', url: '/inheritance-tax-app/', icon: 'Calculator' },
  ...
  // 贈与税関連
  { title: '贈与税計算シミュレーター', description: '贈与税・間接税のシミュレーション', url: '/gift-tax-simulator/', icon: 'Gift' },
  { title: '贈与税申告 必要書類案内', description: '贈与税申告に必要な書類をご案内', url: '/gift-tax-docs/', icon: 'ClipboardList' },
  { title: '間接税シミュレーター', description: '土地・建物取得時の税金計算', url: '/gift-tax-simulator/real-estate', icon: 'Home' },
  // 株式評価
