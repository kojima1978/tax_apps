...
const TaxReference = () => (
    <TaxReferenceSection label="軽減制度の要件・控除額表">
        ...
        <section className="tax-ref-section">
            ...
            <h3 className="tax-ref-h3">【軽減の計算方法】</h3>
            <div className="tax-ref-formula-block">
                <div><strong>ア</strong>　45,000円</div>
                <div><strong>イ</strong>　土地1㎡当たりの価格（宅地は評価額×1/2÷地積）×　住宅の床面積の2倍（1戸200㎡限度）×　住宅の取得持分　×　3%</div>
                <div className="tax-ref-note">適用額: ア・イのうち大きい方を土地の税額から減額（税額が減額額未満の場合はその額が限度）</div>
            </div>

            <div className="tax-ref-two-col">
                <div>
                    <h3 className="tax-ref-h3">【適用要件】（1）新築住宅用の土地</h3>
                    <ul className="tax-ref-ul">
                    ...
                    <p className="tax-ref-note">※当該住宅がQ12の軽減要件を満たす場合に限る　（地方税法第73条の24第1項）</p>
                </div>
                <div>
                    <h3 className="tax-ref-h3">【適用要件】（2）中古住宅用の土地</h3>
                    <ul className="tax-ref-ul">
                        <li><strong>ア 土地を先に取得した場合：</strong>取得日から1年以内（同時取得含む）に当該土地上の中古住宅を取得</li>
                        <li><strong>イ 中古住宅を先に取得した場合：</strong>住宅取得後1年以内に敷地取得</li>
                    </ul>
                    <p className="tax-ref-note">※当該住宅がQ13の軽減要件を満たす場合に限る　（地方税法第73条の24第2項・第3項）</p>
                </div>
            </div>

            <p className="tax-ref-src">出典: https://www.tax.metro.tokyo.lg.jp/shitsumon/real_estate/f#q14</p>
        </section>
        ...
        <section className="tax-ref-section">
            ...
            <div className="tax-ref-two-col">
                <div>
                    <h3 className="tax-ref-h3">【適用要件】次のア〜ウすべてを満たすこと</h3>
                    <ul className="tax-ref-ul">
                    ...
                    <p className="tax-ref-note">※昭和29年6月30日以前新築の住宅は要件を満たしても控除なし</p>
                    <p className="tax-ref-note">（法第73条の14第3項）</p>

                    <h3 className="tax-ref-h3" style={{ marginTop: '0.5rem' }}>【計算式】</h3>
                    <p>（固定資産評価額 − 控除額）× 3% ＝ 税額</p>
                    <p className="tax-ref-note">※持分取得の場合は評価額・控除額に持分を乗じた額</p>
                </div>

                <div>
                    <h3 className="tax-ref-h3">【控除額テーブル】</h3>
                    <table className="tax-ref-table">
                        ...
                        <tbody>
                            {DEDUCTION_TABLE.map(({ period, amount }) => (
                                <tr key={period}>
                                    <td>{period}</td>
                                    <td className="tax-ref-td-right">{amount}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                    <p className="tax-ref-note" style={{ marginTop: '0.25rem' }}>
            ...
            <p className="tax-ref-src">出典: https://www.tax.metro.tokyo.lg.jp/shitsumon/real_estate/f#q13</p>
        </section>
    </TaxReferenceSection>
);
