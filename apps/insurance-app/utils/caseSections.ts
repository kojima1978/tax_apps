// アイコンは本文の見出しと揃える(受取人別=Users, 種類説明=BookOpen, 個別分析=FileSearch)。
// グラフは死亡保障が逓減する内容なので TrendingUp(右肩上がり)ではなく ChartArea を使う。
import { LayoutDashboard, ChartArea, Users, BookOpen, FileSearch, type LucideIcon } from 'lucide-react';
...
export const CASE_SECTIONS: CaseSectionDef[] = [
  ...
  { key: 'charts', label: '保障・コストの推移', description: '死亡保障と月額負担の年齢推移', icon: ChartArea },
  ...
  { key: 'analysis', label: '個別分析', description: '証券ごとの詳細分析とコメント', icon: FileSearch },
];
