    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg dark:shadow-slate-900/50 overflow-hidden p-4">
      ...
      <div className="space-y-3">
        <InlineAddInput
          ...
          inputClass="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 dark:bg-slate-800 dark:text-slate-200"
        />
        <label className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300 cursor-pointer">
          ...
          />
          <span className={isSpecial ? 'text-purple-600 dark:text-purple-400 font-medium' : ''}>
            特例カテゴリとして追加
          </span>
        </label>
      </div>
